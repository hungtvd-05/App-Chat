...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        imageDown = new ImageIcon(getClass().getResource("/com/app/icon/download.png")).getImage();
        imageCancel = new ImageIcon(getClass().getResource("/com/app/icon/cancel.png")).getImage();
        imageFile = new ImageIcon(getClass().getResource("/com/app/icon/file.png")).getImage();
    }
