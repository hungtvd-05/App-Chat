...
public class Emogi {
    ...
    public List<Model_Emoji> getStyle1() {
        ...
        for (int i = 1; i <= 20; i++) {
            list.add(new Model_Emoji(i, new ImageIcon(getClass().getResource("/com/app/icon/emoji/" + i + ".png"))));
        }
        return list;
    }
    ...
    public Model_Emoji getImoji(int id) {
        return new Model_Emoji(id, new ImageIcon(getClass().getResource("/com/app/icon/emoji/" + id + ".png")));
    }
}
